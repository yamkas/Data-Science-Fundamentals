...
Catatan ini akan menjelaskan beberapa konsep fundamental dalam Deep Learning, termasuk jenis fungsi biaya (cost functions), dan algoritma optimasi yang digunakan untuk melatih model.
